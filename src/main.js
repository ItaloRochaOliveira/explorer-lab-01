...
securityCodeMasked.on("accept", () => {
    updateSecurtityCode(securityCodeMasked.value)
})

function updateSecurtityCode(code){
...
function updateExpirationDate(date){
    ...
    ccExpiration.innerText = date.length === 0 ? `02/${String(new Date().getFullYear() + 10).slice(2)}` : date
}